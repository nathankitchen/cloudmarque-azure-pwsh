...
RequiredModules = @(@{ModuleName = 'Az'; RequiredVersion = '4.6.1'; })
...
FunctionsToExport = 'Clear-CmAzContext', 'Get-CmAzContext', 'Get-CmAzResourceName',
               ...
               'New-CmAzIaaSWVD', 'New-CmAzPaasSharedImageGallery',
               'New-CmAzPaasSql', 'New-CmAzPaasWeb', 'New-CmAzPaasWebStatic', 
